...
if (in_array('logo', $active_options)) { ?>
    ...
    if (qrcdr()->getConfig('uploader') == true || count($watermarks) > 0) {
        $listwatermarks = '';
    ...
    <div class="collapse<?php echo $collapsed; ?>" id="collapseFrame"<?php echo $accordion_parent; ?>>
        ...
        <div class="col-12 mb-2">
            ...
            <div class="form-group mt-2">
                <div class="form-check form-switch">
                  <input type="checkbox" class="form-check-input collapse-control" id="frame-color" data-bs-toggle="collapse" data-bs-target="#collapse-frame-color" name="custom_frame_color">
